...
void rbc_67_vec_set_random_tmp(seedexpander_shake_t* ctx, rbc_67_vec o, uint32_t size);

void rbc_67_vec_set_random_from_xof(rbc_67_vec o,
                                 uint32_t size,
                                 void (*xof)(uint8_t *, size_t, const uint8_t *, size_t),
                                 const uint8_t *xof_input,
                                 uint32_t xof_size);

void rbc_67_vec_set_random_fixed_rank(random_source* ctx, rbc_67_vec o, uint32_t size, int32_t rank);
...
void rbc_67_vec_set_random_full_rank_with_one_tmp(seedexpander_shake_t* ctx, rbc_67_vec o, uint32_t size);
...
void rbc_67_vec_set_random_from_support_tmp(seedexpander_shake_t* ctx, rbc_67_vec o, uint32_t size, const rbc_67_vec support, uint32_t support_size, uint8_t copy_flag);
...
void rbc_67_vec_from_bytes_without_mask(rbc_67_vec o, uint32_t size, const uint8_t *random);
